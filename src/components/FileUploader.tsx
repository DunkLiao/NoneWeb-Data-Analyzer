...
export const FileUploader: React.FC<FileUploaderProps> = ({
  ...
  return (
    <div className="mb-6">
      ...
      <div className="mt-3 flex items-center justify-between px-3 py-2 bg-slate-100/70 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800/80 rounded-xl text-xs">
        <span className="text-slate-600 dark:text-slate-400">沒有準備好的檔案嗎？您可以一鍵載入真實分析範例資料進行體驗：</span>
        <button
